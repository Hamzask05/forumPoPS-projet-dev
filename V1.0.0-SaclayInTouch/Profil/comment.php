    ...
    if (!empty($COMMENT['image']) && file_exists($COMMENT['image'])) {
...
?>
              ...
              <a href="post_singulier.php?id=<?php echo $COMMENT['postid']?>">
                Commentaire</a> . <span class="date"><?php echo $COMMENT['date']
               ?> </span>
            </div>
          </div>